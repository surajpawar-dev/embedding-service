...
public final class ErrorMessage {
    ...
    public static final String INCOMPLETE_CHUNK_SET = "Document Processing Service returned an incomplete chunk set";
    ...
    public static final String EMBEDDING_COUNT_MISMATCH = "Embedding provider returned a different number of vectors than requested";
    public static final String EMBEDDING_DIMENSION_MISMATCH = "Embedding provider returned a vector with an unexpected dimension";
