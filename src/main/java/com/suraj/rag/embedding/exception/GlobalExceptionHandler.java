...
import com.suraj.rag.embedding.common.HeaderNames;
import com.suraj.rag.embedding.common.MdcKeys;
import com.suraj.rag.embedding.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> handleEmbedding(
            EmbeddingException exception, HttpServletRequest request) {
        log.warn(
                "Handled embedding exception: code={}, path={}, message={}",
                exception.errorCode(),
    ...
    ResponseEntity<ErrorResponse> handleUnknown(Exception exception, HttpServletRequest request) {
        ...
        return build(
                ...
                ErrorMessage.UNEXPECTED_SERVICE_FAILURE,
                request);
    }
    ...
    private ResponseEntity<ErrorResponse> build(
            HttpStatus status, ErrorCode error, String message, HttpServletRequest request) {
